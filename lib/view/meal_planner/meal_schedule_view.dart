...
import '../../common_widget/nutrition_row.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          AppLocalizations.of(context)?.mealSchedule ?? "Meal Schedule",
          style: TextStyle(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context)?.snacks ?? "Snacks",
                        style: TextStyle(
                            color: TColor.black,
                            fontSize: 16,
                            fontWeight: FontWeight.w700),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context)?.todayMealNutritions ??
